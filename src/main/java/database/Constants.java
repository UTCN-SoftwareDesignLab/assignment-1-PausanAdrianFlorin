...
public class Constants {
    ...
    public static class Tables {
        ...
        public static final String[] ORDERED_TABLES_FOR_CREATION = new String[]{USER, ROLE, RIGHT,
                ROLE_RIGHT, USER_ROLE, CLIENT, ACCOUNT, ACTIVITY};
    }
    ...
    public static class Rights {
        ...
        public static final String[] RIGHTS = new String[]{CREATE_USER, DELETE_USER, UPDATE_USER,
                CREATE_CLIENT, UPDATE_CLIENT, CREATE_ACCOUNT, DELETE_ACCOUNT, UPDATE_ACCOUNT};
    }
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        ROLES_RIGHTS.get(EMPLOYEE).addAll(Arrays.asList(CREATE_CLIENT, UPDATE_CLIENT, CREATE_ACCOUNT,
